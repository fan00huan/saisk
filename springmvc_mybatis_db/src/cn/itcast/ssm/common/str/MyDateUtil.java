 ...
 *
 */
public final class MyDateUtil implements Serializable {
...
//		System.out.println(getYearByDate(new Date()));
	 ...
	 * @return String 指定格式的日期字符串.
	 */
	public static String getFormatTime(Date date)throws Exception {
	 ...
	 * @return String 指定格式的日期字符串.
	 */
	public static String getFormatCurrentTime(String format)throws Exception {
		return getFormatDateTime(new Date(), format);
	}
	 ...
	 * @return String 指定格式的日期字符串.
	 */
	public static String getFormatDateTime(Date date, String format) throws Exception{
	 ...
	 * @return yyyy/MM/dd
	 */
	public static String getDateTomorrow(String date)throws Exception {
	 ...
	 * @return yyyy/MM/dd
	 */
	public static String getDateOffset(String date, int offset)throws Exception {
	 ...
	 * @return 当前月份有多少天；
	 */
	public static int getDaysOfCurMonth()throws Exception {
	 ...
	 * @return Date 加上一定天数以后的Date对象.
	 */
	public static String getFormatDateAdd(Date date, int amount, String format)throws Exception {
		Calendar cal = new GregorianCalendar();
		cal.setTime(date);
		cal.add(GregorianCalendar.DATE, amount);
	 ...
	 */
	public static String getFormatCurrentAdd(int amount, String format)throws Exception {
	 ...
	 */
	public static String getFormatYestoday(String format)throws Exception {
	 ...
	 */
	public static String getYestoday(String sourceDate, String format)throws Exception {
	 ...
	 * @return 返回日期字符串，形式和formcat一致。
	 */
	public static String getFormatTomorrow(String format)throws Exception {
		return getFormatCurrentAdd(1, format);
	}
	 ...
	 * @return 返回日期字符串，形式和formcat一致。
	 */
	public static String getFormatDateTommorrow(String sourceDate, String format)throws Exception {
		return getFormatDateAdd(getDateFromString(sourceDate, format), 1, format);
	}
	 ...
	 * @throws ParseException 
	 */
	public static long getDiff(String startTime, String endTime) throws ParseException {
		long diff = 0;
	 ...
	 * @return String 指定格式的日期字符串.
	 */
	public static String getDateTime(long microsecond)throws Exception {
	 ...
	 * @return String 指定格式的日期字符串.
	 */
	public static String getDateTime(long microsecond, String pattarn)throws Exception {
	 ...
	 * @return Float 加几实数小时.
	 */
	public static String getDateByAddFltHour(float flt)throws Exception {
	 ...
	 * @return 时间.
	 */
	public static String getDateByAddHour(String datetime, String pattarn, int minute)throws Exception {
	 ...
	 * @throws ParseException 
	 */
	public static int getDiffHour(String startTime, String endTime) throws ParseException {
		long diff = 0;
		SimpleDateFormat ft = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			Date startDate = ft.parse(startTime);
			Date endDate = ft.parse(endTime);
	 ...
	 * @throws ParseException 
	 */
	public static int countWeekend(String startDate, String endDate) throws ParseException {
		int result = 0;
		Date sdate = null;
		Date edate = null;
...
*/
	 ...
	 * @throws ParseException 
	 */
	public static int getDiffDays(String startDate, String endDate) throws ParseException {
		long diff = 0;
	 ...
	 * @return 返回一个字符串数组对象
	 */
	public static String[] getArrayDiffDays(String startDate, String endDate)throws Exception {
